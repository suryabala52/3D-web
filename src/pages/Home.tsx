...
// SPLINE URLS
const HERO_SCENE =
  "https://prod.spline.design/izow8QsZqwvQaQfF/scene.splinecode";
const PRODUCT_SCENE =
  "https://prod.spline.design/pPOLEPpqBmohl4xY/scene.splinecode";
      ...
      <div ref={containerRef} className="w-full">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            >
              Build intelligent AI agents that automate workflows, interact with
              customers, and transform the way your business operates.
            </motion.p>
          ...
          <div className="container mx-auto px-6 flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              ...
              {[
                ...
                <div
                  key={i}
                  className="text-xl font-bold tracking-tighter text-white/80"
                >
                  {name}
                </div>
              ))}
          ...
          <div className="container mx-auto px-6">
            <div className="mb-16 md:mb-24 text-center max-w-3xl mx-auto">
              ...
              <p className="text-zinc-400 text-lg">
                We deliver custom AI integrations that give you a competitive
                edge, automating the mundane and unlocking the extraordinary.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Autonomous entities that execute complex multi-step workflows without human intervention.",
                },
                {
                  title: "AI Chatbots",
                  icon: <MessageSquare className="w-8 h-8 text-secondary" />,
                  desc: "Conversational interfaces that understand context, nuance, and user intent perfectly.",
                },
                {
                  title: "AI Automation",
                  icon: <Zap className="w-8 h-8 text-accent" />,
                  desc: "Seamless integration between your tools, driven by intelligent decision-making algorithms.",
                },
                {
                  title: "AI Websites",
                  icon: <Globe className="w-8 h-8 text-primary" />,
                  desc: "Dynamic digital experiences that adapt in real-time to user behavior and preferences.",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <a
                    href="#"
                    className="flex items-center gap-2 text-sm font-medium text-white group-hover:text-primary transition-colors"
                  >
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="lg:w-1/2">
                ...
                <p className="text-xl text-zinc-400 mb-8 leading-relaxed">
                  Our core reasoning engine is built to handle complex
                  multimodal inputs, giving your agents the power to see, hear,
                  and understand exactly like a human.
                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 text-center">
              {[
                ...
                <div key={i} className="flex flex-col items-center">
                  ...
                  <div className="text-sm md:text-base text-zinc-500 uppercase tracking-widest">
                    {stat.label}
                  </div>
                </div>
              ))}
        ...
        <section className="py-32 relative overflow-hidden flex items-center justify-center min-h-[60vh]">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto">
              Stop waiting for the future. Start building it today with our
